...
(1, 'Naruto', '9780743273565', 1925), 
(2, 'Haikyuu', '9780061120084', 1960), 
(3, 'Hunter x Hunter', '9780451524935', 1949);
SELECT * FROM Books;
...
(101, 'Nauto', 'uzumaki.naruto@email.com'), 
(102, 'Hinata', 'shoyo.hinata@email.com'), 
(103, 'Killua', 'killua.zoldyck@email.com');
SELECT * FROM Members; 
CREATE TABLE Loans ( 
